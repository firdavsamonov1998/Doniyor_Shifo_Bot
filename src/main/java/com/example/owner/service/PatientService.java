...
public class PatientService {
    ...
    public List<PatientDTO> getPatientByFullName(String name) {
        ...
        List<PatientEntity> entityList = patientRepository.getByFullNameContainingIgnoreCaseAndStatus(name,Status.ACTIVE);
    ...
    public Integer getCountFloor(String floorNumber) {
        return patientRepository.countByFloorStartingWithAndStatus(floorNumber, Status.ACTIVE);
    }
