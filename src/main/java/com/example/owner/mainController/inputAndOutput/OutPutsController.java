...
public class OutPutsController {
                ...
                case Constant.bugungi -> {
                    ...
                    myTelegramBot.send(SendMsg.sendMsg(message.getChatId(),
                            "Sana: " + dto.getCreatedDate() + "\n\n" +
                                    "\uD83D\uDCB3 Plastik chiqimlar miqdori = " + ToDecimalUtil.toStr(dto.getCard()) + " so'm\n"
                    ));
        ...
        if (outPuts.getStep().equals(Step.NAXD)) {
            switch (text) {
                case Constant.bugungi -> {
                    ...
                    myTelegramBot.send(SendMsg.sendMsg(message.getChatId(),
                            "Sana: " + dto.getCreatedDate() + "\n\n" +
                                    "\uD83D\uDCB5 Naxd chiqimlar miqdori = " +ToDecimalUtil.toStr(dto.getCash()) + " so'm\n"
                    ));
                }
        ...
        if (outPuts.getStep().equals(Step.TOTALAMOUNTOUTPUTS)) {
            switch (text) {
                case Constant.bugungi -> {
                    ...
                    myTelegramBot.send(SendMsg.sendMsg(message.getChatId(),
                            "Sana: " + dto.getCreatedDate() + "\n\n" +
                                    "\uD83D\uDCB5 Bugungi umumiy chiqimlar miqdori = " +ToDecimalUtil.toStr(dto.getTotalAmount()) +
                                    " so'm\n"
                    ));
                }
    ...
    public boolean sendSummaByDateNaxd(Message message) {
        ...
        myTelegramBot.send(SendMsg.sendMsg(message.getChatId(),
                "Sana " + dto.getCreatedDate() + "\n\n" +
                        "\uD83D\uDCB5 Naxd chiqimlar miqdori = " + ToDecimalUtil.toStr(dto.getCash()) +
                        " so'm\n"));
        return true;
    }
    ...
    public boolean sendSummaByDatePlastik(Message message) {
        ...
        myTelegramBot.send(SendMsg.sendMsg(message.getChatId(),
                "Sana " + dto.getCreatedDate() + "\n\n" +
                        "\uD83D\uDCB3 Plastik chiqimlar miqdori = " + ToDecimalUtil.toStr(dto.getCard()) +
                        " so'm\n"));
        return true;
    }
    ...
    public boolean sendSummaByDateTotal(Message message) {
        ...
        myTelegramBot.send(SendMsg.sendMsg(message.getChatId(),
                "Sana " + dto.getCreatedDate() + "\n\n" +
                        "\uD83D\uDCB5 kundagi umimiy chiqimlar miqdori = " +ToDecimalUtil.toStr(dto.getTotalAmount()) +
                        " so'm\n"));
        return true;
    }
