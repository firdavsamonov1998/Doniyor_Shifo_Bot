...
public class InputsController {
        ...
        if (inPuts.getStep().equals(Step.NAXDIN)) {
            switch (text) {
                case Constant.bugungi -> {
                    ...
                    String summa = ToDecimalUtil.toStr(dto.getCash());

                    myTelegramBot.send(SendMsg.sendMsg(message.getChatId(),
                            "Sana: " + dto.getCreatedDate() + "\n\n" +
                                    "\uD83D\uDCB5 Naxd kirimlar miqdori = " + summa+ " so'm\n"
                    ));
                    inPuts.setStep(Step.NAXDIN);
                ...
                case Constant.kun10 -> {
                    ...
                    for (InputDTO dto : dtoList) {
                        ...
                        myTelegramBot.send(SendMsg.sendMsg(message.getChatId(),
                                "Sana: "+dto.getCreatedDate()+"\n" +
                                        "\uD83D\uDCB5 Naxd Summa: "+  ToDecimalUtil.toStr(dto.getCash()) +" so'm \n"));
                    }
        ...
        if (inPuts.getStep().equals(Step.PLASTIKIN)) {
            switch (text) {
                case Constant.bugungi -> {
                    ...
                    myTelegramBot.send(SendMsg.sendMsg(message.getChatId(),
                            "Sana: " + dto.getCreatedDate() + "\n\n" +
                                    "\uD83D\uDCB3 Plastik kirimlar miqdori = " +ToDecimalUtil.toStr(dto.getCard()) + " so'm\n"
                    ));
                ...
                case Constant.kun10 -> {
                    ...
                    for (InputDTO dto : dtoList) {
                        myTelegramBot.send(SendMsg.sendMsg(message.getChatId(),
                                "Sana: "+dto.getCreatedDate()+"\n" +
                                        "\uD83D\uDCB5 Plastik Summa: "+ToDecimalUtil.toStr(dto.getCard())+" so'm \n"));
                    }
        ...
        if (inPuts.getStep().equals(Step.TOTALAMOUNTINPUTS)) {
            switch (text) {
                case Constant.bugungi -> {
                    ...
                    myTelegramBot.send(SendMsg.sendMsg(message.getChatId(),
                            "Sana: " + dto.getCreatedDate() + "\n\n" +
                                    "\uD83D\uDCB5 Bugungi umumiy kirimlar miqdori = " +ToDecimalUtil.toStr(dto.getTotalAmount()) +
                                    " so'm\n"
                    ));
                ...
                case Constant.kun10 -> {
                    ...
                    for (InputDTO dto : dtoList) {
                        myTelegramBot.send(SendMsg.sendMsg(message.getChatId(),
                                "Sana: "+dto.getCreatedDate()+"\n" +
                                        "\uD83D\uDCB5 Umumiy Summa: "+ToDecimalUtil.toStr(dto.getTotalAmount())+" so'm \n"));
                    }
    ...
    public boolean sendSummaByDateNaxd(Message message){
        ...
        myTelegramBot.send(SendMsg.sendMsg(message.getChatId(),
                "Sana " + dto.getCreatedDate() + "\n\n" +
                        "\uD83D\uDCB5 Naxd kirimlar miqdori = " + ToDecimalUtil.toStr(dto.getCash()) +
                        " so'm\n"));
        return true;
    }
    ...
    public boolean sendSummaByDatePlastik(Message message){
        ...
        myTelegramBot.send(SendMsg.sendMsg(message.getChatId(),
                "Sana " + dto.getCreatedDate() + "\n\n" +
                        "\uD83D\uDCB3 Plastik kirimlar miqdori = " + ToDecimalUtil.toStr(dto.getCard()) +
                        " so'm\n"));
        return true;
    }
    ...
    public boolean sendSummaByDateTotal(Message message){
        ...
        myTelegramBot.send(SendMsg.sendMsg(message.getChatId(),
                "Sana " + dto.getCreatedDate() + "\n\n" +
                        "\uD83D\uDCB5 kundagi umimiy kirimlar miqdori = " + ToDecimalUtil.toStr(dto.getTotalAmount()) +
                        " so'm\n"));
        return true;
    }
