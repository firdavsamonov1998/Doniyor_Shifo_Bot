...
public class NurseService {
    ...
    public NurseService(PatientRepository patientRepository, MyTelegramBot myTelegramBot) {
    ...
    public void enterFullName(Message message) {
        myTelegramBot.send(SendMsg.sendMsgParse(message.getChatId(), "Bemorning  *Ism va Familyasini* va  ⬇️ \n" +
                "biriktirilgan *Doktor Ism va Familiyani* kiriting masalan (Ali. V)"));
    }
    ...
    public void nurseMenuButton(Message message) {
        ...
        myTelegramBot.send(SendMsg.sendMsgParse(message.getChatId(),
                " *Registratsiya Bo'limi*  ✅ : ", Button.markup(Button.rowList(
                        Button.row(Button.button(Constant.bemorQoshish),
                                Button.button(Constant.bemorQidirish)),
                        Button.row(Button.button(Constant.bemorOchirish),
    ...
    public void nurseMenuButton2(Message message) {
        ...
        myTelegramBot.send(SendMsg.sendMsgParse(message.getChatId(),
                ...
                Button.markup(Button.rowList(Button.row(Button.button(Constant.bemorQoshish),
                                Button.button(Constant.bemorQidirish)),
                        Button.row(Button.button(Constant.bemorOchirish),
                                Button.button(Constant.bemorlarRoyhati)))
                )));
    ...
    public boolean handlePatient(Message message) {
        ...
        List<PatientEntity> entityList = patientRepository.getByFullNameContainingIgnoreCaseAndStatus(message.getText(), Status.ACTIVE);
    ...
    public void patientListForAdmin(Message message) {
